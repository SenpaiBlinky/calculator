...
function setupIntialValues() {
  document.getElementById("loan-amount").value = 1;
...
function update() {
  ...
  let resultOnScreen = document.getElementById("monthly-payment");
  resultOnScreen.innerHTML = number
}
...
function calculateMonthlyPayment(values) {
  ...
  let numerator = principle * rate;
  let denominator = 1 - ( 1 + rate ) ** (- years)
